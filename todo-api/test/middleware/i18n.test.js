...
describe('i18n middleware', () => {
  ...
  it('exact language match', async () => {
    ...
    await request(app)
      .get('/locale')
      .set('Accept-Language', 'pa,sv;q=0.8,fi;q=0.7,it-ch;q=0.5,en-us;q=0.3,en;q=0.2')
  ...
  it('best locale without region', async () => {
    ...
    await request(app)
      .get('/locale')
      .set('Accept-Language', 'pa-it,sv;q=0.8,fi;q=0.7,it-ch;q=0.5,en-us;q=0.3,en;q=0.2')
      .expect(200, {locale: 'pa'})
  })

  it('dont go into region without best match', async () => {

    app.get('/locale', [i18nMiddleware(['af', 'en-US', 'pa-IT'], 'en-US'), route])
  ...
  it('dont match finnish to ligurian', async () => {
    ...
    await request(app)
      .get('/locale')
      .set('Accept-Language', 'fil-PH,fil;q=0.97,en-US;q=0.94,en;q=0.91,en-ph;' +
  ...
  it('support ligurian', async () => {
    ...
    app.get('/locale', [i18nMiddleware(['en-US', 'fi', 'fil-PH'], 'en-US'), route])
